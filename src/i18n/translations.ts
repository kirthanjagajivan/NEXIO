...
export const translations: Record<Language, Translation> = {
  ...
  de: {
    ...
    practical_tasks: 'Praktische Aufgaben',
    assigned_trainees: 'Zugewiesene Auszubildende',
    create_task: 'Aufgabe erstellen',
    task_title: 'Aufgabentitel',
    task_description: 'Beschreibung',
    task_instructions: 'Anweisungen',
    ...
    trainee_list: 'Auszubildendenliste',
    assign_trainee: 'Auszubildenden zuweisen',
    unassign_trainee: 'Zuweisung aufheben',
    feedback_text: 'Feedback',
    rating: 'Bewertung',
    topic: 'Thema',
    no_feedback: 'Noch kein Feedback',
    view_submissions: 'Einreichungen anzeigen',
    submit_task: 'Aufgabe einreichen',
    submission_status: 'Status',
    pending: 'Ausstehend',
    submitted: 'Eingereicht',
    reviewed: 'Überprüft',
    manage_practical_tasks: 'Praktische Aufgaben für Auszubildende erstellen und verwalten',
    create_first_task: 'Erstellen Sie Ihre erste praktische Aufgabe',
    manage_trainees: 'Zugewiesene Auszubildende anzeigen und verwalten',
    assign_first_trainee: 'Weisen Sie Ihren ersten Auszubildenden zu',
    no_trainees: 'Noch keine Auszubildenden zugewiesen',
    trainee_performance: 'Lernfortschritt Ihrer Auszubildenden überwachen',
    no_data: 'Keine Daten verfügbar',
    across_trainees: 'Alle Auszubildenden',
    active_trainees: 'Aktive Auszubildende',
    assigned_to_you: 'Ihnen zugewiesen',
    trainee_progress: 'Fortschritt der Auszubildenden',
    manage_feedback: 'Feedback an Ihre Auszubildenden geben',
    assign_trainee_first: 'Weisen Sie zuerst einen Auszubildenden zu',
    no_feedback_yet: 'Noch kein Feedback gegeben',
    recent_tasks: 'Aktuelle Aufgaben',
    recent_feedback: 'Aktuelles Feedback',
    recent_activity: 'Aktuelle Aktivität',
    weak_topics: 'Schwache Themen',
    all_topics_passed: 'Alle Themen bestanden!',
    overall_performance: 'Gesamtleistung',
    passed: 'Bestanden',
    attempts: 'Versuche',
    optional: 'optional',
    search: 'Suchen',
    teacher_learning: 'Lernbereich Lehrer',
    trainer_tasks: 'Ausbilder-Aufgaben',
    academic_learning: 'Akademisches Lernen',
    academic_learning_desc: 'Theoriestunden, Quiz und vom Lehrer hochgeladene Inhalte',
    practical_training: 'Praktische Ausbildung',
    practical_training_desc: 'Arbeitsplatzaufgaben, Zuweisungen und Unternehmensschulungen',
    academic_progress: 'Akademischer Fortschritt',
    practical_progress: 'Praktischer Fortschritt',
    passed_lessons: 'Bestandene Lektionen',
    passed_tasks: 'Bestandene Aufgaben',
    weak_tasks: 'Schwache Aufgaben',
    all_tasks_passed: 'Alle Aufgaben bestanden!',
    tasks_completed: 'Abgeschlossene Aufgaben',
    academic_performance_desc: 'Akademischen Fortschritt und Quizergebnisse der Schüler überwachen',
    practical_performance_desc: 'Praktische Aufgabenleistung der Auszubildenden überwachen',
    attachments: 'Anhänge',
    upload_files: 'Klicken zum Hochladen',
    upload_files_hint: 'PDF, Bilder, Word-Dokumente, Textdateien (max. 50 MB)',
    review_submissions: 'Einreichungen',
    review_submissions_desc: 'Einreichungen der Auszubildenden prüfen, genehmigen oder ablehnen',
    review_submission: 'Einreichung prüfen',
    no_submissions: 'Keine Einreichungen vorhanden',
    submit_review: 'Bewertung absenden',
    submission_text: 'Ihre Antwort',
    trainer_materials: 'Ausbildungsmaterialien',
    trainer_feedback: 'Ausbilder-Feedback',
    my_submission: 'Meine Einreichung',
    attach_files: 'Dateien anhängen (PDF, Bilder, Dokumente)',
  ...
  tr: {
    ...
    trainee_list: 'Stajyer Listesi',
    assign_trainee: 'Stajyer Ata',
    unassign_trainee: 'Atamayı Kaldır',
    feedback_text: 'Geri Bildirim',
    rating: 'Değerlendirme',
    topic: 'Konu',
    no_feedback: 'Henüz geri bildirim yok',
    view_submissions: 'Gönderimleri Görüntüle',
    submit_task: 'Görevi Gönder',
    submission_status: 'Durum',
    pending: 'Beklemede',
    submitted: 'Gönderildi',
    reviewed: 'İncelendi',
    manage_practical_tasks: 'Stajyerler için pratik görevler oluşturun ve yönetin',
    create_first_task: 'Başlamak için ilk pratik görevinizi oluşturun',
    manage_trainees: 'Atanmış stajyerleri görüntüleyin ve yönetin',
    assign_first_trainee: 'Başlamak için ilk stajyerinizi atayın',
    no_trainees: 'Henüz stajyer atanmadı',
    trainee_performance: 'Stajyerlerinizin öğrenme ilerlemesini izleyin',
    no_data: 'Veri mevcut değil',
    across_trainees: 'Tüm stajyerler',
    active_trainees: 'Aktif Stajyerler',
    assigned_to_you: 'Size atanmış',
    trainee_progress: 'Stajyer İlerlemesi',
    manage_feedback: 'Stajyerlerinize geri bildirim verin',
    assign_trainee_first: 'Geri bildirim eklemek için önce stajyer atayın',
    no_feedback_yet: 'Henüz geri bildirim verilmedi',
    recent_tasks: 'Son Görevler',
    recent_feedback: 'Son Geri Bildirimler',
    recent_activity: 'Son Aktivite',
    weak_topics: 'Zayıf Konular',
    all_topics_passed: 'Tüm konular geçildi!',
    overall_performance: 'Genel Performans',
    passed: 'Geçildi',
    attempts: 'Denemeler',
    optional: 'isteğe bağlı',
    search: 'Ara',
    teacher_learning: 'Öğretmen Dersleri',
    trainer_tasks: 'Eğitmen Görevleri',
    academic_learning: 'Akademik Öğrenme',
    academic_learning_desc: 'Teori dersleri, quizler ve öğretmen içerikleri',
    practical_training: 'Pratik Eğitim',
    practical_training_desc: 'İş yeri görevleri, ödevler ve şirket eğitim içerikleri',
    academic_progress: 'Akademik İlerleme',
    practical_progress: 'Pratik İlerleme',
    passed_lessons: 'Geçilen Dersler',
    passed_tasks: 'Geçilen Görevler',
    weak_tasks: 'Zayıf Görevler',
    all_tasks_passed: 'Tüm görevler geçildi!',
    tasks_completed: 'Tamamlanan Görevler',
    academic_performance_desc: 'Öğrenci akademik ilerlemesini ve quiz puanlarını izleyin',
    practical_performance_desc: 'Stajyer pratik görev performansını izleyin',
    attachments: 'Ekler',
    upload_files: 'Dosya yüklemek için tıklayın',
    upload_files_hint: 'PDF, Görseller, Word belgeleri, Metin dosyaları (maks. 50 MB)',
    review_submissions: 'Gönderimler',
    review_submissions_desc: 'Stajyer gönderimlerini inceleyin, onaylayın veya reddedin',
    review_submission: 'Gönderimi İncele',
    no_submissions: 'Burada gönderi yok',
    submit_review: 'İncelemeyi Gönder',
    submission_text: 'Yanıtınız',
    trainer_materials: 'Eğitmen Materyalleri',
    trainer_feedback: 'Eğitmen Geri Bildirimi',
    my_submission: 'Gönderim',
    attach_files: 'Dosya ekle (PDF, görseller, belgeler)',
  ...
  ar: {
    ...
    practical_tasks: 'المهام العملية',
    assigned_trainees: 'المتدربون المعيّنون',
    create_task: 'إنشاء مهمة',
    task_title: 'عنوان المهمة',
    task_description: 'الوصف',
    task_instructions: 'التعليمات',
    ...
    assign_trainee: 'تعيين متدرب',
    unassign_trainee: 'إلغاء التعيين',
    feedback_text: 'التغذية الراجعة',
    rating: 'التقييم',
    topic: 'الموضوع',
    no_feedback: 'لا توجد تغذية راجعة بعد',
    view_submissions: 'عرض التسليمات',
    submit_task: 'تسليم المهمة',
    submission_status: 'الحالة',
    pending: 'قيد الانتظار',
    submitted: 'مُسلَّم',
    reviewed: 'تمت المراجعة',
    manage_practical_tasks: 'إنشاء وإدارة المهام العملية للمتدربين',
    create_first_task: 'أنشئ مهمتك العملية الأولى للبدء',
    manage_trainees: 'عرض وإدارة المتدربين المعيّنين',
    assign_first_trainee: 'عيّن متدربك الأول للبدء',
    no_trainees: 'لم يتم تعيين متدربين بعد',
    trainee_performance: 'مراقبة تقدم تعلم المتدربين',
    no_data: 'لا توجد بيانات',
    across_trainees: 'جميع المتدربين',
    active_trainees: 'المتدربون النشطون',
    assigned_to_you: 'المعيّنون إليك',
    trainee_progress: 'تقدم المتدرب',
    manage_feedback: 'تقديم تغذية راجعة للمتدربين',
    assign_trainee_first: 'عيّن متدرباً أولاً لإضافة تغذية راجعة',
    no_feedback_yet: 'لم تُقدَّم تغذية راجعة بعد',
    recent_tasks: 'المهام الأخيرة',
    recent_feedback: 'التغذية الراجعة الأخيرة',
    recent_activity: 'النشاط الأخير',
    weak_topics: 'المواضيع الضعيفة',
    all_topics_passed: 'تم اجتياز جميع المواضيع!',
    overall_performance: 'الأداء العام',
    passed: 'اجتاز',
    attempts: 'المحاولات',
    optional: 'اختياري',
    search: 'بحث',
    teacher_learning: 'التعلم الأكاديمي',
    trainer_tasks: 'مهام المدرب',
    academic_learning: 'التعلم الأكاديمي',
    academic_learning_desc: 'الدروس النظرية والاختبارات والمحتوى الذي يرفعه المعلم',
    practical_training: 'التدريب العملي',
    practical_training_desc: 'مهام مكان العمل والتكليفات ومحتوى تدريب الشركة',
    academic_progress: 'التقدم الأكاديمي',
    practical_progress: 'التقدم العملي',
    passed_lessons: 'الدروس المجتازة',
    passed_tasks: 'المهام المجتازة',
    weak_tasks: 'المهام الضعيفة',
    all_tasks_passed: 'تم اجتياز جميع المهام!',
    tasks_completed: 'المهام المكتملة',
    academic_performance_desc: 'مراقبة التقدم الأكاديمي ودرجات الاختبارات',
    practical_performance_desc: 'مراقبة أداء المهام العملية للمتدربين',
    attachments: 'المرفقات',
    upload_files: 'انقر لرفع الملفات',
    upload_files_hint: 'PDF، صور، مستندات Word، ملفات نصية (الحد الأقصى 50 ميغابايت)',
    review_submissions: 'التسليمات',
    review_submissions_desc: 'مراجعة تسليمات المتدربين والموافقة عليها أو رفضها',
    review_submission: 'مراجعة التسليم',
    no_submissions: 'لا توجد تسليمات هنا',
    submit_review: 'إرسال المراجعة',
    submission_text: 'إجابتك',
    trainer_materials: 'مواد المدرب',
    trainer_feedback: 'تغذية راجعة من المدرب',
    my_submission: 'تسليمي',
    attach_files: 'إرفاق ملفات (PDF، صور، مستندات)',
  ...
  ru: {
    ...
    assigned_trainees: 'Назначенные стажёры',
    create_task: 'Создать задание',
    task_title: 'Название задания',
    task_description: 'Описание',
    task_instructions: 'Инструкции',
    difficulty_level: 'Уровень сложности',
    estimated_duration: 'Примерная продолжительность',
    minutes: 'мин',
    edit_task: 'Редактировать',
    delete_task: 'Удалить',
    no_tasks: 'Заданий пока нет',
    trainee_list: 'Список стажёров',
    assign_trainee: 'Назначить стажёра',
    unassign_trainee: 'Снять назначение',
    feedback_text: 'Обратная связь',
    rating: 'Оценка',
    topic: 'Тема',
    no_feedback: 'Обратной связи пока нет',
    view_submissions: 'Просмотреть ответы',
    submit_task: 'Отправить задание',
    submission_status: 'Статус',
    pending: 'Ожидает',
    submitted: 'Отправлено',
    reviewed: 'Проверено',
    manage_practical_tasks: 'Создавать и управлять практическими заданиями',
    create_first_task: 'Создайте первое практическое задание',
    manage_trainees: 'Просматривать и управлять назначенными стажёрами',
    assign_first_trainee: 'Назначьте первого стажёра для начала',
    no_trainees: 'Стажёры ещё не назначены',
    trainee_performance: 'Отслеживать учебный прогресс стажёров',
    no_data: 'Данных нет',
    across_trainees: 'По всем стажёрам',
    active_trainees: 'Активные стажёры',
    assigned_to_you: 'Назначены вам',
    trainee_progress: 'Прогресс стажёра',
    manage_feedback: 'Давать обратную связь стажёрам',
    assign_trainee_first: 'Сначала назначьте стажёра для добавления отзыва',
    no_feedback_yet: 'Обратной связи ещё не давалось',
    recent_tasks: 'Последние задания',
    recent_feedback: 'Последняя обратная связь',
    recent_activity: 'Последняя активность',
    weak_topics: 'Слабые темы',
    all_topics_passed: 'Все темы пройдены!',
    overall_performance: 'Общая успеваемость',
    passed: 'Пройдено',
    attempts: 'Попытки',
    optional: 'необязательно',
    search: 'Поиск',
    teacher_learning: 'Учебные материалы',
    trainer_tasks: 'Задания тренера',
    academic_learning: 'Академическое обучение',
    academic_learning_desc: 'Теоретические уроки, тесты и материалы от учителей',
    practical_training: 'Практическое обучение',
    practical_training_desc: 'Задания на рабочем месте и корпоративный учебный контент',
    academic_progress: 'Академический прогресс',
    practical_progress: 'Практический прогресс',
    passed_lessons: 'Пройденные уроки',
    passed_tasks: 'Пройденные задания',
    weak_tasks: 'Слабые задания',
    all_tasks_passed: 'Все задания пройдены!',
    tasks_completed: 'Выполненные задания',
    academic_performance_desc: 'Мониторинг академической успеваемости и результатов тестов',
    practical_performance_desc: 'Мониторинг практических заданий стажёров',
    attachments: 'Вложения',
    upload_files: 'Нажмите для загрузки файлов',
    upload_files_hint: 'PDF, изображения, документы Word, текстовые файлы (макс. 50 МБ)',
    review_submissions: 'Ответы',
    review_submissions_desc: 'Просматривать, одобрять или отклонять ответы стажёров',
    review_submission: 'Проверить ответ',
    no_submissions: 'Здесь нет ответов',
    submit_review: 'Отправить проверку',
    submission_text: 'Ваш ответ',
    trainer_materials: 'Материалы тренера',
    trainer_feedback: 'Обратная связь от тренера',
    my_submission: 'Мой ответ',
    attach_files: 'Прикрепить файлы (PDF, изображения, документы)',
    submitting: 'Отправка…',
