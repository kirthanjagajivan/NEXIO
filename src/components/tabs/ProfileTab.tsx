  ...
  return (
    <div className="max-w-2xl">
      <div className="bg-[#1E293B] border border-slate-700/60 rounded-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-700 to-blue-900 h-24" />

        <div className="px-6 pb-6">
          <div className="flex items-end gap-4 -mt-12 mb-6">
            <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl border-4 border-slate-800 flex items-center justify-center shadow-lg">
              <User className="w-12 h-12 text-white" />
            </div>
            <div className="flex-1 pb-2">
              <h2 className="text-2xl font-bold text-white">{profile.full_name || 'User'}</h2>
              <p className="text-sm text-slate-400">{roleLabels[profile.role] || profile.role}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-800/50 border border-slate-700/40 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide">{t.profileEmail}</p>
                </div>
                <p className="text-sm font-medium text-slate-100 mt-1">{profile.email}</p>
              </div>
              <div className="bg-slate-800/50 border border-slate-700/40 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-1">
                  <BarChart3 size={14} className="text-slate-400" />
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide">{t.profileLevel}</p>
                </div>
                <p className="text-sm font-medium text-slate-100 mt-1">{proficiencyLabels[profile.german_proficiency] || profile.german_proficiency}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-800/50 border border-slate-700/40 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide">{t.native_language}</p>
                </div>
              ...
              <div className="bg-slate-800/50 border border-slate-700/40 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide">{t.app_language}</p>
                </div>
                <p className="text-sm font-medium text-slate-100 mt-1">
