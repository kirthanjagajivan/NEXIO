  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-center gap-3">
        ...
        <div>
          <p className="font-semibold text-emerald-900">{t.academic_learning || 'Academic Learning'}</p>
          <p className="text-sm text-emerald-700">{t.academic_learning_desc || 'Theory lessons, quizzes, and teacher-uploaded content'}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-green-700">{t.passed_lessons || 'Passed Lessons'}</span>
          </div>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-purple-700">{t.academic_progress || 'Academic Progress'}</span>
          </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
          <h2 className="font-semibold text-gray-800 text-sm">{t.academic_progress || 'Academic Progress'}</h2>
        </div>
